 ...
 */
(function(){var a=function(a){function b(a){a=a||{},a.font=a.font||"bold 20pt Arial",a.fill=a.fill||"black",a.stroke=a.stroke||"black",a.strokeThickness=a.strokeThickness||0,a.dropShadow=a.dropShadow||!1,a.dropShadowAngle=a.dropShadowAngle||Math.PI/6,a.dropShadowDistance=a.dropShadowDistance||4,a.dropShadowColor=a.dropShadowColor||"black"}function c(a,b){return{text:a,style:b,width:0,height:0,fontProperties:null}}if(a){var d=function(b,c,d){a.Text.call(this,b,d),this.setTextStyles(c)};d.prototype=Object.create(a.Text.prototype),d.prototype.constructor=d,d.prototype.setAlignmentStyle=d.prototype.setStyle=function(a){a=a||{},a.align=a.align||"left",a.wordWrap=a.wordWrap||!1,a.wordWrapWidth=a.wordWrapWidth||100,this.style=a,this.dirty=!0},d.prototype.setTextStyles=function(a){for(var c in a)a.hasOwnProperty(c)&&b(a[c]);a.def||(a.def={},b(a.def)),this.textStyles=a,this.dirty=!0},d.prototype._getTextDataPerLine=function(a){for(var b=[],d=Object.keys(this.textStyles).join("|"),e=new RegExp("</?("+d+")>","g"),f=this.textStyles.def,g=0;g<a.length;g++){for(var h,i=[],j=[];null!==(h=e.exec(a[g]))&&j.push(h););if(j.length){for(var k=0,l=0;l<j.length;l++)j[l].index>k&&i.push(c(a[g].substring(k,j[l].index),f)),f="/"==j[l][0][1]?this.textStyles.def:this.textStyles[j[l][1]]||this.textStyles.def,k=j[l].index+j[l][0].length;k<a[g].length&&i.push({text:a[g].substring(k),style:this.textStyles.def})}else i.push(c(a[g],f));b.push(i)}return b},d.prototype.updateText=function(){this.texture.baseTexture.resolution=this.resolution;var a,b,c=this.text,d=this.textStyles;this.style.wordWrap&&(c=this.wordWrap(this.text));var e=c.split(/(?:\r\n|\r|\n)/),f=this._getTextDataPerLine(e),g=[],h=[],i=0;for(a=0;a<e.length;a++){var j=0,k=0;for(b=0;b<f[a].length;b++)this.context.font=f[a][b].style.font,f[a][b].width=this.context.measureText(f[a][b].text).width,j+=f[a][b].width,f[a][b].fontProperties=this.determineFontProperties(f[a][b].style.font),f[a][b].height=f[a][b].fontProperties.fontSize+f[a][b].style.strokeThickness,k=Math.max(k,f[a][b].height);g[a]=j,h[a]=k,i=Math.max(i,j)}var l=Object.keys(d).map(function(a){return d[a]}),m=l.reduce(function(a,b){return Math.max(a,b.strokeThickness)},0),n=l.reduce(function(a,b){var c=b.dropShadow?b.dropShadowDistance:0;return Math.max(a,c)},0),o=i+m+n,p=Math.max.apply(null,h)*e.length+n;this.canvas.width=(o+this.context.lineWidth)*this.resolution,this.canvas.height=p*this.resolution,this.context.scale(this.resolution,this.resolution),navigator.isCocoonJS&&this.context.clearRect(0,0,this.canvas.width,this.canvas.height),this.context.textBaseline="alphabetic",this.context.lineJoin="round";var q,r;for(a=0;a<f.length;a++){var s=f[a];for(q=0,b=0;b<s.length;b++){var t=s[b].style,u=s[b].text,v=s[b].fontProperties;if(this.context.font=t.font,this.context.strokeStyle=t.stroke,this.context.lineWidth=t.strokeThickness,q+=m/2,r=m/2+a*h[a]+v.ascent,"right"===this.style.align?q+=i-g[a]:"center"===this.style.align&&(q+=(i-g[a])/2),"bottom"===t.valign?r+=h[a]-s[b].height-(m-t.strokeThickness)/2:"middle"===t.valign&&(r+=(h[a]-s[b].height)/2-(m-t.strokeThickness)/2),t.dropShadow){this.context.fillStyle=t.dropShadowColor;var w=Math.sin(t.dropShadowAngle)*t.dropShadowDistance,x=Math.cos(t.dropShadowAngle)*t.dropShadowDistance;t.fill&&this.context.fillText(u,q+w,r+x)}this.context.fillStyle=t.fill,t.stroke&&t.strokeThickness&&this.context.strokeText(u,q,r),t.fill&&this.context.fillText(u,q,r),q+=s[b].width,q-=m/2}}this.updateTexture()},a.MultiStyleText=d}};"undefined"!=typeof module?module.exports=a:a(this.PIXI)}).call(this);